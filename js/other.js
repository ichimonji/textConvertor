const
  ...
  latinVariety = [
    ...
    [ 'b', ['ƀɃ','ɓƁ','ƃƂ','ƅƄ','ḃḂ','ḅḄ','ḇḆ','ꞗꞖ','ᵬ','ᶀ','ᴃ'] ],
    [ 'c', ['çÇ','ćĆ','ĉĈ','ċĊ','čČ','ɔƆ','ƈƇ','ḉḈ','c̄C̄','ȼȻ','ɕ'] ],
    [ 'd', ['ðᴆÐ','ďĎ','ɗƊ','ɖƉ','ƌƋ','ḋḊ','ḍḌ','ḏḎ','ḑḐ','ḓḒ','ȡ'] ],
  ...
  // 符号付文字入力用
  latinVariety2 = {
    'a': ['àÀ','áÁ','âÂ','ãÃ','äÄ','åÅ','āĀ','ăĂ','ąĄ','ǎǍ','ǻǺ','ȁȀ','ȃȂ','ȧȦ','ạẠ','ảẢ','ấẤ','ầẦ','ẩẨ','ẫẪ','ậẬ','ắẮ','ằẰ','ẳẲ','ẵẴ','ặẶ','ḁḀ','ⱥȺ','ǡǠ','ǟǞ'],
    'b': ['ƀɃ','ɓƁ','ƃƂ','ƅƄ','ḃḂ','ḅḄ','ḇḆ','ꞗꞖ','ᵬᵬ','ᶀᶀ'],
    'c': ['çÇ','ćĆ','ĉĈ','ċĊ','čČ','ɔƆ','ƈƇ','ḉḈ','c̄C̄','ȼȻ','ɕɕ','ꞓꞒ'],
    'd': ['ðÐ','ďĎ','ɗƊ','ɖƉ','ƌƋ','ḋḊ','ḍḌ','ḏḎ','ḑḐ','ḓḒ','ȡȡ','đĐ'],
    'e': ['èÈ','éÉ','êÊ','ëË','ēĒ','ĕĔ','ėĖ','ęĘ','ěĚ','ǝƎ','əƏ','ȅȄ','ȇȆ','ȩȨ','ḕḔ','ḗḖ','ḙḘ','ḛḚ','ḝḜ','ẹẸ','ẻẺ','ẽẼ','ếẾ','ềỀ','ểỂ','ễỄ','ệỆ','ɇɆ','ꬳꬳ'],
    'f': ['ḟḞ','ƒƑ'],
    'g': ['ĝĜ','ğĞ','ġĠ','ģĢ','ǥǤ','ǧǦ','ǵǴ','ḡḠ','ɠƓ','ᶃᶃ','ɢɢ'],
    'h': ['ĥĤ','ħĦ','ȟȞ','ḣḢ','ḥḤ','ḧḦ','ḩḨ','ḫḪ','ⱨⱧ','ẖẖ','ɦɦ'],
    'i': ['ìÌ','íÍ','îÎ','ïÏ','ĩĨ','īĪ','ĭĬ','įĮ','ıİ','ǐǏ','ȉȈ','ȋȊ','ḭḬ','ḯḮ','ỉỈ','ịỊ','ıı','İİ','ɨƗ'],
    'j': ['ĵĴ','ǰǰ','ɉɈ'],
    'k': ['ķĶ','ǩǨ','ḱḰ','ḳḲ','ḵḴ','ƙƘ','ꝃꝂ','ꝁꝀ','ꝅꝄ'],
    'l': ['ĺĹ','ļĻ','ľĽ','ŀĿ','łŁ','ḷḶ','ḹḸ','ḻḺ','ḽḼ','ƚȽ','ⱡⱠ','ꝉꝈ','łŁ','ᴌᴌ'],
    'm': ['ḿḾ','ṁṀ','ṃṂ','ᶆᶆ'],
    'n': ['ñÑ','ńŃ','ņŅ','ňŇ','ǹǸ','ṅṄ','ṇṆ','ṉṈ','ṋṊ','ɲƝ','ƞȠ','ᵰᵰ','ᶇᶇ','ɳɳ','ȵȵ','ɴɴ'],
    'o': ['òÒ','óÓ','ôÔ','õÕ','öÖ','ōŌ','ŏŎ','őŐ','ǒǑ','ǫǪ','ǭǬ','ȍȌ','ȏȎ','ȫȪ','ȭȬ','ȯȮ','ȱȰ','ṍṌ','ṏṎ','ṑṐ','ṓṒ','ốỐ','ồỒ','ổỔ','ỗỖ','ộỘ','ớỚ','ờỜ','ởỞ','ỡỠ','ợỢ','ọỌ','ỏỎ','øØ','ǿǾ','ꝍꝌ'],
    'p': ['ṕṔ','ṗṖ','ƥƤ','ᵽⱣ','ꝑꝐ','ꝓꝒ'],
    'q': ['ɋɊ','ʠʠ','ꝙꝘ'],
    'r': ['ŕŔ','ŗŖ','řŘ','ȑȐ','ȓȒ','ṙṘ','ṛṚ','ṝṜ','ṟṞ','ɍɌ','ɽⱤ','ᵲᵲ','ᶉᶉ','ɼɼ','ɾɾ','ᵳᵳ','ʀʀ'],
    's': ['śŚ','ŝŜ','şŞ','šŠ','șȘ','ṡṠ','ṣṢ','ṥṤ','ṧṦ','ṩṨ','ſſ','ᵴᵴ','ᶊᶊ','ʂʂ','ȿȿ'],
    't': ['ţŢ','ťŤ','ŧŦ','țȚ','ṫṪ','ṭṬ','ṯṮ','ṱṰ','ƭƬ','ẗẗ','ⱦȾ'],
    'u': ['ùÙ','úÚ','ûÛ','üÜ','ũŨ','ūŪ','ŭŬ','ůŮ','űŰ','ųŲ','ǔǓ','ǖǕ','ǘǗ','ǚǙ','ǜǛ','ȕȔ','ȗȖ','ṳṲ','ṵṴ','ṷṶ','ṹṸ','ṻṺ','ụỤ','ủỦ','ứỨ','ừỪ','ửỬ','ữỮ','ựỰ','ʋƲ','Ưư','Ʉʉ','ᵾᵾ','ᶙᶙ','ᴜᴜ'],
    'v': ['ṽṼ','ṿṾ','ꝟꝞ'],
    'w': ['ŵŴ','ẁẀ','ẃẂ','ẅẄ','ẇẆ','ẉẈ','ⱳⱲ','ẘẘ','ƜƜ'],
    'x': ['ẋẊ','ẍẌ'],
