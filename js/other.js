const
  ...
  latinVariety2 = {
    ...
    'c': ['çÇ','ćĆ','ĉĈ','ċĊ','čČ','ɔƆ','ƈƇ','ḉḈ','c̄C̄','ȼȻ','ɕɕ'],
    'd': ['ðÐ','ďĎ','ɗƊ','ɖƉ','ƌƋ','ḋḊ','ḍḌ','ḏḎ','ḑḐ','ḓḒ','ȡȡ'],
    'e': ['èÈ','éÉ','êÊ','ëË','ēĒ','ĕĔ','ėĖ','ęĘ','ěĚ','ǝƎ','əƏ','ȅȄ','ȇȆ','ȩȨ','ḕḔ','ḗḖ','ḙḘ','ḛḚ','ḝḜ','ẹẸ','ẻẺ','ẽẼ','ếẾ','ềỀ','ểỂ','ễỄ','ệỆ'],
    'f': ['ḟḞ','ƒƑ'],
    'g': ['ĝĜ','ğĞ','ġĠ','ģĢ','ǥǤ','ǧǦ','ǵǴ','ḡḠ','ɠƓ','ᶃᶃ','ɢɢ'],
    'h': ['ĥĤ','ħĦ','ȟȞ','ḣḢ','ḥḤ','ḧḦ','ḩḨ','ḫḪ','ⱨⱧ','ẖẖ','ɦɦ'],
    'i': ['ìÌ','íÍ','îÎ','ïÏ','ĩĨ','īĪ','ĭĬ','įĮ','ıİ','ǐǏ','ȉȈ','ȋȊ','ḭḬ','ḯḮ','ỉỈ','ịỊ','ıı','İİ'],
    'j': ['ĵĴ','ǰǰ'],
    'k': ['ķĶ','ǩǨ','ḱḰ','ḳḲ','ḵḴ','ƙƘ'],
    'l': ['ĺĹ','ļĻ','ľĽ','ŀĿ','łŁ','ḷḶ','ḹḸ','ḻḺ','ḽḼ'],
    'm': ['ḿḾ','ṁṀ','ṃṂ','ᶆᶆ'],
    ...
    's': ['śŚ','ŝŜ','şŞ','šŠ','șȘ','ṡṠ','ṣṢ','ṥṤ','ṧṦ','ṩṨ','ſſ'],
    't': ['ţŢ','ťŤ','ŧŦ','țȚ','ṫṪ','ṭṬ','ṯṮ','ṱṰ','ƭƬ','ẗẗ'],
    ...
    'x': ['ẋẊ','ẍẌ'],
    'y': ['ýÝ','ÿŸ','ŷŶ','ȳȲ','ẏẎ','ỳỲ','ỵỴ','ỷỶ','ỹỸ','ƴƳ','ẙẙ'],
